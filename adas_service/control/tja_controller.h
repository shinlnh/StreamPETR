#ifndef __TJA_CONTROLLER_H__
#define __TJA_CONTROLLER_H__
...
// #define TUNE_TJA_SPEED_KEEPING
// #define TUNE_TJA_DISTANCE_KEEPING
class TJAController: public Controller, public FuzzyController
{
private:
    ...
    LogUtility tja_speed_logging = LogUtility("log/", "tja_speed_keeping_log", false);       
#endif

#ifdef TUNE_TJA_DISTANCE_KEEPING
    LogUtility tja_distance_logging = LogUtility("log/", "tja_distance_keeping_log", false);
#endif
public:
    TJAController();
    void reset();
    ...
    void initializeWithThrottle(float throttle)
    {
        ...
        this->resetClock();
        DEBUG("Initialized TJA controller with throttle: %f (uk_1: %f)", throttle, pi_fuzzy_velocity.uk_1);
    }
};

#endif // __TJA_CONTROLLER_H__
