...
def parse_args():
    ...
    parser.add_argument("mode", choices=["train", "test", "export"], help="Train, test or export?")
    parser.add_argument("--exp_name", help="Experiment name", required=True)
    parser.add_argument("--cfg", help="Config file")
    parser.add_argument("--resume", action="store_true", help="Resume training")
    parser.add_argument("--epoch", type=int, help="Test/export model trained to this epoch")
    ...
    parser.add_argument("--output_path", help="Path to save exported ONNX model")
    ...
    if args.exp_name is None and args.mode in ('test', 'export'):
        raise Exception("Experience name is required for testing and exporting")
...
def main():
    ...
    if args.mode == 'train':
        ...
        runner.export(epoch=args.epoch or exp.get_last_checkpoint_epoch(), output_path= args.output_path or (exp.name + '.onnx'))
