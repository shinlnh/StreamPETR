...
CONFIG="projects/configs/StreamPETR/stream_petr_r50_carla_4cam_ped_far.py"
FAR_INFO="$ROOT/data/carla/carla_streampetr_infos_train_ped_far.pkl"
WORK_DIR="$ROOT/work_dirs/stream_petr_r50_carla_4cam_ped_far_stride8"
...
[[ -f "$FAR_INFO" ]] || {
  echo "Far-pedestrian dataset is not ready: $FAR_INFO" >&2
  exit 1
}
