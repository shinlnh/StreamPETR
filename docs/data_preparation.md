...
For the local CARLA collection flow, see
[`tools/carla_town04/README.md`](../tools/carla_town04/README.md). The collector
generates six-camera images plus StreamPETR-compatible temporal info files under
`data/carla_town04_nuscenes_rig/` by default; it does not require nuScenes JSON
tables. The earlier hybrid-camera experiment remains under `data/carla_town04/`.
